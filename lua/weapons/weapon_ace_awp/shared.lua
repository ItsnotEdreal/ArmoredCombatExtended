...
SWEP.HeatReductionRate = 2400 --Heat loss per second when not firing
SWEP.HeatPerShot = 35 --Heat generated per shot
...
SWEP.AngularRecoil = -0.5	--Amount of angular recoil
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 20 --Volume of the case as a cylinder * Powder density converted from g to kg
	...
	self.BulletData.PenArea = self.BulletData.FrArea ^ ACF.PenAreaMod * 4
