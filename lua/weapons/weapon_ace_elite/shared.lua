...
SWEP.Primary.Sound = "ace_weapons/sweps/multi_sound/elite_multi.mp3"
...
SWEP.MovementSpread = 0.5 --Increase aimcone to this many degrees when sprinting at full speed
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 1.8 --Volume of the case as a cylinder * Powder density converted from g to kg
